...
type Check struct {
	...
	GameServer  int    `gorm:"type:int(10);not null;default:0" form:"game_server" json:"game_server" valid:"Required;Range(1, 10000)"`
	GamePos     int    `gorm:"type:int(10);not null;default:0" form:"game_pos" json:"game_pos" valid:"Required;Range(1, 10000)"`
	GameLevel   string `gorm:"type:varchar(20);not null;default:''" form:"game_level" json:"game_level" valid:"Required;MaxSize(20)"`
	GameLevelId int    `gorm:"type:int(10);not null;default:0" form:"game_level_id" json:"game_level_id" valid:"Required;Range(1, 1000000)"`
